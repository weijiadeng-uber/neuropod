 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_com_uber_neuropod_Neuropod_nativeGetAllocator
  (JNIEnv *, jclass, jlong);
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_uber_neuropod_Neuropod_nativeGetGenericAllocator
  (JNIEnv *, jclass);
...
JNIEXPORT jobject JNICALL Java_com_uber_neuropod_Neuropod_nativeInfer
  (JNIEnv *, jclass, jobjectArray, jobject, jlong);
