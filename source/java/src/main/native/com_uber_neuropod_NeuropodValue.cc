...
JNIEXPORT jobject JNICALL Java_com_uber_neuropod_NeuropodValue_nativeToList(JNIEnv *env, jclass, jlong nativeHandle)
{
    try
    {
        ...
        case neuropod::FLOAT_TENSOR: {
            ...
            jfloatArray floatArray = static_cast<jfloatArray>(env->CallObjectMethod(ret, java_nio_FloatBuffer_array));
        ...
        case neuropod::DOUBLE_TENSOR: {
            ...
            jdoubleArray doubleArray =
                static_cast<jdoubleArray>(env->CallObjectMethod(ret, java_nio_DoubleBuffer_array));
...
JNIEXPORT jobject JNICALL Java_com_uber_neuropod_NeuropodValue_nativeGetDims(JNIEnv *env, jclass, jlong handle)
{
    try
    {
